...
exports.getAllContactInfo = async(req, res) => {
    try {
        ...
        res.status(500).json({ message: 'Une erreur est survenue lors de la récupération des informations de contact' });
    }
};
...
exports.createContactInfo = async(req, res) => {
    ...
    try {
        ...
        console.error('Erreur lors de la création des informations de contact :', error);
        res.status(500).json({ message: 'Une erreur est survenue lors de la création des informations de contact' });
    }
};
...
exports.updateContactInfo = async(req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Une erreur est survenue lors de la mise à jour des informations de contact' });
    }
};
...
exports.deleteContactInfo = async(req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Une erreur est survenue lors de la suppression des informations de contact' });
    }
};